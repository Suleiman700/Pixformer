...
var Html5QrcodeScanner = function() {
    ...
    return _createClass(a, [{
        ...
        value: function() {
            ...
            g.className = "btn btn-primary mx-auto";
            g.innerHTML = "לחצו לסריקה",
                g.addEventListener("click", function() {
                    g.disabled = !0,
                        b.__setStatus("PERMISSION"),
                        b.__setHeaderMessage("בקשת גישה למצלמה..."),
        ...
        value: function(b) {
            ...
            e.innerHTML = "בחירת מצלמה: (".concat(b.length, ") &nbsp;"),
            ...
            (n.innerHTML = "התחילו בסריקה"),
            (n.className = "btn btn-primary mx-auto"),
            n.id = "startScanning",
                m.appendChild(n);
            var o = document.createElement("button");
            (o.innerHTML = "הפסקת סריקה"),
            (o.className = "btn btn-danger mx-auto"),
            o.id = "stopScanning",

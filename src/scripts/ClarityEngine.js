...
export default class ClarityEngine {
    ...
    get_tile(_x, _y) {
        ...
        return (this.current_map.data[_y] && this.current_map.data[_y][_x]) ? this.current_map.data[_y][_x] : 0;
    };
    ...
    error(_message) {
        if (this.alert_errors) alert(_message);
